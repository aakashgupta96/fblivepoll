class Constant < ActiveRecord::Base
  ...
  DEFAULT_PROMOTION_MESSAGE = "To make something like this, visit www.shurikenlive.com"

  LIVE_POLLING_RESTRICTED_MESSAGE = "Live Pollings are restricted by Facebook as mentioned in their policies. Please continue at your own risk. We recommend you to use our Video Streaming plugin."
end
